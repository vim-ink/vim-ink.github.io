...
var files = {
    editor: {
        parsedSource: [
            ...
            [s(), l('  3 ', 'CursorLineNr'), gc('CursorLine', spaces(2)), gc('Cursor', 'T'), gc('CursorLine', 'he cursor' + spaces(88))],
            [s(), l('  4 '), c(spaces(96)), gc('ColorColumn', ' ')],
            [s(), l('  5 '), gc('Visual', 'These words'), c(' are selected' + spaces(72)), gc('ColorColumn', ' ')],
            ...
            [s(), l(' 10 ')],
            [s('--'), l(' 11 '), gc('DiffDelete', 'This line was deleted' + spaces(79))],
            [s(), l(' 12 '), gc('DiffText', 'These words'), gc('DiffChange', ' on this line was changed' + spaces(64))],
            [s('++'), l(' 13 '), gc('DiffAdd', 'This line was added' + spaces(81))],
            [s(), l(' 14 ')],
    ...
    ui: {
        parsedSource: [
            ...
            [c(fill('', 22, ' ')), gc('VertSplit', '│')],
            [c(fill('', 22, ' ')), gc('VertSplit', '│')],
            [gc('StatusLineNC', fill('inactive status', 23, ' ')), gc('StatusLine', fill('active status', 83, ' '))],
            ...
            [gc('StatusLine', 'one-file  another-file  '), gc('WildMenu', 'a-third-file'), gc('StatusLine', spaces(70))],
        ]
    },
    about: {
