...
var files = {
    vimEditor: {
        ...
        parsedSource: [
            ...
            [sign('  '), line('  4 '), spaces(75), g('ColorColumn', ' ')],
            [sign('  '), line('  5 '), g('Visual', 'These words'), ' are selected' + spaces(51), g('ColorColumn', ' ')],
            ...
            [sign('  '), line(' 14 '), ],
            [sign('  '), line(' 15 '), 'A ', g('SpellBad', 'mispelled'), ' word'],
            [sign('  '), line(' 16 '), g('SpellCap', 'line'), ' starting without capital letter'],
            [sign('  '), line(' 17 '), 'For some reason ', g('SpellLocal', 'okay'), ' is a local word'],
            [sign('  '), line(' 18 '), g('SpellRare', 'vim'), ' seems to be a rare word'],
            [],
